...
(async () => {
  ...
  const url = 'https://developers.khulnasoft.com/api?_expand=true&schema_url=https://raw.githubusercontent.com/khulnasoft/api-schemas/main/openapi.yaml'
  ...
  const filteredLinks = links.filter(link => {
    return link.startsWith('https://developers.khulnasoft.com/api/')
  })
  ...
  const linksWithParam = uniqLinks.map(link => {
    ...
    baseUrl.searchParams.set("schema_url", "https://raw.githubusercontent.com/khulnasoft/api-schemas/main/openapi.yaml")
